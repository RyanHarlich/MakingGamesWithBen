...
namespace Bengine {
	...
	/* NEW: overloaded constructor, for background sprites like blood particles */
	...
	Glyph::Glyph(const glm::vec4& destRect, const glm::vec4& uvRect, GLuint Texture, float Depth, const ColorRGBA8& color, float angle) :
		...
		/* NEW: orgin, usually top left is treated as position */
		glm::vec2 halfDims(destRect.z / 2.0f, destRect.w / 2.0f); 
		/* NEW: vec3 is for 3D games, get points centered at orgin */
		...
		/* NEW: rotate the points, add back half dims to treat top left as position and not orgin */
